  ...
  const items = [
    {
      ...
      label: (
        <div>
          ...
          <div style={{ color: "#a7a7a7", fontSize: "17px" }}>
    ...
    },
    {
      ...
      label: (
        <Link
          to={`profile/${firstTwoUsersInList[0]?.id}`}
          className="contact-name-pic-profile"
          onClick={() => loginHandler(firstTwoUsersInList[0]?.id)}
        >
          <img
    ...
    },
    {
      ...
      label: (
        <Link
          to={`profile/${firstTwoUsersInList[1]?.id}`}
          className="contact-name-pic-profile"
          onClick={() => loginHandler(firstTwoUsersInList[1]?.id)}
        >
          <img
            className="contact-pic-small-profile"
            onError={({ currentTarget }) => {
    ...
    },
    {
      ...
      label: (
        <Link className="logout-link" to="/">
          <button onClick={() => logoutHandler()} className="signout-button">
            Signout
          </button>
        </Link>
      ),
