      ...
      <div className="side-bar-div">
        <div className="side-bar-text-arrow-div">
          <div className="side-bar-text">
            <Link className="link-home-page" to={loggedUserDetails?`profile/${loggedUserDetails.id}`:'/'} onClick={()=>setHeading("Profile")}>
              Profile
            </Link>
          </div>
          {heading === "Profile" ? <div className="arrow-outlet">{">"}</div>:null}
        </div>

        <div className="side-bar-text-arrow-div">
          <div className="side-bar-text">
            <Link className="link-home-page" to="posts" onClick={()=>setHeading("Posts")}>
              Posts
            </Link>
          </div>
          {heading === "Posts" ? <div className="arrow-outlet">{">"}</div>:null}
        </div>

        <div className="side-bar-text-arrow-div">
          <div className="side-bar-text">
            <Link className="link-home-page" to="gallery" onClick={()=>setHeading("Gallery")}>
              Gallery
            </Link>
          </div>
          {heading === "Gallery"?<div className="arrow-outlet">{">"}</div>:null}
        </div>

        <div className="side-bar-text-arrow-div">
          <div className="side-bar-text">
            <Link className="link-home-page" to="todo" onClick={()=>setHeading("Todo")}>
              Todo
            </Link>
          </div>
          {heading === "Todo"?<div><div></div><div className="arrow-outlet">{">"}</div></div>:null}
        </div>
      </div>
